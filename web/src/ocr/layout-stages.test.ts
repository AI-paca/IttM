...
test("line-pair cuts survive wide merged components", () => {
  const features: LayoutFeatures = {
    ...
    foregroundRatio: 0.1,
    separators: [
      { axis: "x", start: 493, end: 495, spanStart: 0, spanEnd: 500, kind: "ink", strength: 0.9 },
      { axis: "x", start: 505, end: 507, spanStart: 0, spanEnd: 500, kind: "ink", strength: 0.9 },
    ],
    components: [
      {
        bbox: [200, 40, 800, 460],
...
test("whitespace cuts crossing wide components are rejected", () => {
  const features: LayoutFeatures = {
    ...
    foregroundRatio: 0.1,
    separators: [
      { axis: "x", start: 490, end: 510, spanStart: 0, spanEnd: 500, kind: "whitespace", strength: 1 },
    ],
    components: [
      {
        bbox: [200, 40, 800, 460],
...
test("single text rows stay one paragraph row instead of whitespace columns", () => {
  const features: LayoutFeatures = {
    ...
    foregroundRatio: 0.1,
    separators: [
      { axis: "x", start: 180, end: 210, spanStart: 0, spanEnd: 77, kind: "whitespace", strength: 1 },
      { axis: "x", start: 480, end: 510, spanStart: 0, spanEnd: 77, kind: "whitespace", strength: 1 },
      { axis: "x", start: 600, end: 630, spanStart: 0, spanEnd: 77, kind: "whitespace", strength: 1 },
      { axis: "x", start: 178, end: 180, spanStart: 0, spanEnd: 77, kind: "ink", strength: 0.7 },
      { axis: "x", start: 210, end: 212, spanStart: 0, spanEnd: 77, kind: "ink", strength: 0.7 },
    ],
    components: [],
    scalars: {},
  };
...
test("single timeline gutters stay one column without table evidence", () => {
  const features: LayoutFeatures = {
    ...
    separators: [
      { axis: "x", start: 1050, end: 1080, spanStart: 0, spanEnd: 926, kind: "whitespace", strength: 0.9 },
      { axis: "y", start: 110, end: 114, spanStart: 0, spanEnd: 1500, kind: "ink", strength: 0.8 },
      { axis: "y", start: 360, end: 364, spanStart: 0, spanEnd: 1500, kind: "ink", strength: 0.8 },
      { axis: "y", start: 700, end: 704, spanStart: 0, spanEnd: 1500, kind: "ink", strength: 0.8 },
    ],
    components: [],
    scalars: {},
  };
...
test("low foreground ink-supported gutters stay one column without table evidence", () => {
  const features: LayoutFeatures = {
    ...
    separators: [
      { axis: "x", start: 585, end: 590, spanStart: 0, spanEnd: 1278, kind: "whitespace", strength: 0.9 },
      { axis: "x", start: 580, end: 582, spanStart: 0, spanEnd: 1278, kind: "ink", strength: 0.8 },
    ],
    components: [],
    scalars: {},
  };
...
test("neighbor gutters and line pairs split card grids deterministically", () => {
  const features: LayoutFeatures = {
    ...
    separators: [
      ...
      { axis: "x", start: 233, end: 235, spanStart: 0, spanEnd: 600, kind: "ink", strength: 0.26 },
      { axis: "x", start: 425, end: 427, spanStart: 0, spanEnd: 600, kind: "ink", strength: 0.26 },
      {
        axis: "x",
        start: 427,
        end: 443,
      ...
      { axis: "x", start: 443, end: 445, spanStart: 0, spanEnd: 600, kind: "ink", strength: 0.22 },
      { axis: "x", start: 634, end: 636, spanStart: 0, spanEnd: 600, kind: "ink", strength: 0.22 },
      { axis: "x", start: 652, end: 654, spanStart: 0, spanEnd: 600, kind: "ink", strength: 0.3 },
      { axis: "x", start: 673, end: 675, spanStart: 0, spanEnd: 600, kind: "ink", strength: 0.22 },
      { axis: "x", start: 821, end: 823, spanStart: 0, spanEnd: 600, kind: "ink", strength: 0.22 },
      { axis: "x", start: 843, end: 845, spanStart: 0, spanEnd: 600, kind: "ink", strength: 0.3 },
      { axis: "x", start: 861, end: 863, spanStart: 0, spanEnd: 600, kind: "ink", strength: 0.26 },
      { axis: "x", start: 1052, end: 1054, spanStart: 0, spanEnd: 600, kind: "ink", strength: 0.26 },
      {
        axis: "x",
        start: 1054,
        end: 1070,
      ...
      { axis: "x", start: 1070, end: 1072, spanStart: 0, spanEnd: 600, kind: "ink", strength: 0.28 },
      { axis: "x", start: 1240, end: 1241, spanStart: 0, spanEnd: 600, kind: "ink", strength: 0.18 },
      { axis: "x", start: 1261, end: 1263, spanStart: 0, spanEnd: 600, kind: "ink", strength: 0.28 },
    ],
    components: [],
    scalars: {},
  };
