...
| `recursive_table_cell_ocr_batch_pixels` | `240000`                          | лимит пикселей одного батча micro-cell OCR |
...
| `recursive_table_cell_ocr_batch_pixels` | `OcrPipelineProfile.recursive_table_cell_ocr_batch_pixels` |
