...
| Shared decisions   | bounded recipe, evidence и deduplication          | `pipeline-core` ABI 3 в native и WASM                             |
...
4. Зафиксировать native/WASM parity ABI 3 и отдельно определить судьбу
