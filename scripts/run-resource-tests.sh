...
if [[ "$tier" == "quality" ]]; then
  ...
  pytest_targets=(
    tests/test_ocr_quality.py::test_generated_functional_ocr_quality_matrix
    tests/test_visual_mutations.py::test_tesseract_preserves_identifiers_across_visual_mutations
  )
