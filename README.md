...
| -------------------------------------------- | ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Client-side (Browser Engine, PDF Парсер)** | Нулевой                   | 100% Client-side в песочнице V8. Вычислительные данные не покидают устройство на сетевом уровне.                                                                    |
...
- **[Границы ответственности и точки входа](./docs/boundaries.md)**
