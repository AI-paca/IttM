...
const objects: NativeTextObject[] = [
  {
    ...
    rows: [[0, 1], [2, 3]],
    cells: [
      { row: 0, column: 0, rowSpan: 1, columnSpan: 1, bbox, candidateIndexes: [0] },
      { row: 0, column: 1, rowSpan: 1, columnSpan: 1, bbox, candidateIndexes: [1] },
      { row: 1, column: 0, rowSpan: 1, columnSpan: 1, bbox, candidateIndexes: [2] },
      { row: 1, column: 1, rowSpan: 1, columnSpan: 1, bbox, candidateIndexes: [3] },
    ],
  },
];
